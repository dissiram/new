            ...
            @if ($showForm)
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/updateCustomer', $data->id) }}" method="post"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" value="{{ $data->name }}"
                                                name="nom" id="basic-icon-default-fullname" placeholder="John Doe"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select id="basic-icon-default-phone" class="form-control phone-mask"
                                                ...
                                                <option value="formator"
                                                    {{ $data->role == 'formator' ? 'selected' : '' }}>Formateur</option>
                                                <option value="customer"
                                                    {{ $data->role != 'formator' ? 'selected' : '' }}>Customer</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-start">
                                    <div class="col-sm-10">
                                        ...
                                        <button class="btn btn-danger ms-2"><a
                                                href="{{ url('admin/customer') }}">Annuler</a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/customer', $user->id) }}"><i
                                                            class="bx bx-edit-alt me-1"></i> Modifier</a>
                                                    <a class="dropdown-item"
                                                        onclick="return confirm('Etês-vous sur de vouloir effacer ce client ?')"
                                                        href="{{ url('admin/deleteCustomer', $user->id) }}"><i
