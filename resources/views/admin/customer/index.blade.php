                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Formations achev&eacute;es</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Formations en cours</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Favoris</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Mes certifications</h6>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Formations disponibles &agrave; la une</h4>
                            </div>
                            <div class="card-body">
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="card">
                    ...
                    <div class="card-content pb-4">
                        ...
                        <div class="px-4">
                            <button class='btn btn-block btn-xl btn-outline-primary font-bold mt-3'>Les notifications</button>
                        </div>
                    </div>
                </div>
                {{-- <div class="card">
