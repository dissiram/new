...
use App\Filament\Formator\Resources\FormateurResource\Pages;
use App\Filament\Formator\Resources\FormateurResource\RelationManagers;
...
class FormateurResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewFormateur::route('/{record}'),
